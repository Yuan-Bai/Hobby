...
public class CombatSystem {
    ...
    public void privarity(Object o){
        varity = new int[per.bai.cardgame.Card.varity];
        if (o instanceof per.bai.cardgame.YuanBai){
            per.bai.cardgame.YuanBai y = (per.bai.cardgame.YuanBai)o;
            varity[per.bai.cardgame.AttackCard.number] = y.attackcard;
            varity[per.bai.cardgame.ArmorCard.number] = y.armorcard;
            varity[per.bai.cardgame.CureCard.number] = y.curecard;
        }else if (o instanceof per.bai.cardgame.Slimer){
            per.bai.cardgame.Slimer s = (per.bai.cardgame.Slimer)o;
            varity[per.bai.cardgame.AttackCard.number] = s.attackcard;
            varity[per.bai.cardgame.ArmorCard.number] = s.armorcard;
            varity[per.bai.cardgame.CureCard.number] = s.curecard;
        }
    }
     */
