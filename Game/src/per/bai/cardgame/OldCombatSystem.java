...
public class OldCombatSystem {
    ...
    /*public static void main(String[] args) {
        ...
        per.bai.cardgame.CombatSystem combatSystem = new per.bai.cardgame.CombatSystem();
        per.bai.cardgame.CombatSystem combatSystem1 = new per.bai.cardgame.CombatSystem();
        boolean b = true;
        ...
        if (1 == sc.nextInt()) {
            while (b) {
                per.bai.cardgame.YuanBai y = new per.bai.cardgame.YuanBai();
                per.bai.cardgame.Monster m;
                combatSystem.whichis(y);
                combatSystem.Cardsort();
                combatSystem.privarity(per.bai.cardgame.Card.varity, y);
                combatSystem.per.bai.cardgame.Card();
                //combatSystem1.whichare(new per.bai.cardgame.Slimer());
                //combatSystem1.Cardsort();
                //combatSystem1.privarity(per.bai.cardgame.Card.varity, new per.bai.cardgame.Slimer());
                //combatSystem1.per.bai.cardgame.Card();
                Random r = new Random();
                int  choosemonster = r.nextInt(5);
                switch (choosemonster){
                    case 1 :
                        m = new per.bai.cardgame.Slimer();
                    default:
                        m = new per.bai.cardgame.Slimer();
                }
                int count = 4;
                int t;
                if (m instanceof per.bai.cardgame.Slimer) {
                    per.bai.cardgame.Slimer s = (per.bai.cardgame.Slimer) m;
                    while (true) {
                        while (true) {
                            System.out.println("====================================================================");
                            System.out.println("====================================================================");
                            per.bai.cardgame.CombatSystem.printMonster(m);
